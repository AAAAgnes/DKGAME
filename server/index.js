...
const DECK_JOB = [
    ...
    { id: 30, name: '검사', description: '느림의 미학, 흙을 만지는 고독한 예술가.' },
    { id: 31, name: '파티시에', description: '달콤함 속에 감춘 쓴맛, 섬세하고 까다로운 성격.' },
    { id: 32, name: '사육사', description: '이상과 현실을 설계하는, 창조의 전문가.' },
    ...
    { id: 42, name: '승무원', description: '의지할 수 있는 존재이자, 때로는 넘을 수 없는 벽.' },
    { id: 43, name: '인형탈알바', description: '항상 밝은 에너지로 다가오는, 지켜주고 싶은 존재.' },
    ...
    { id: 47, name: '버튜버', description: '법적으로 형제, 혈연을 뛰어넘는 감정의 금기.' },
    { id: 48, name: '스승', description: '가르침을 주는 멘토, 존경과 욕망 사이.' },
    { id: 49, name: '형사', description: '돈, 복수 등 목적이 있는 기간 한정 관계의 상대.' },
    { id: 50, name: '메이드', description: '어릴 적부터 묶인 운명, 짊어져야 할 무게.' },
    { id: 51, name: '수녀', description: '충동적인 만남 후, 잊으려 했지만 잊을 수 없는 인연.' },
    { id: 52, name: '파일럿', description: '복종과 명령을 내리는, 절대적인 권력의 소유자.' },
    { id: 53, name: '양아치', description: '나를 절망에서 구해준, 보답해야 할 존재.' },
    { id: 54, name: '한량', description: '증오로 시작되지만, 시간이 갈수록 흔들리는 감정의 대상.' },
    { id: 55, name: '가정주부', description: '일방적인 보호와 의존, 헌신적인 사랑을 받는 존재.' },
    ...
    { id: 67, name: '너드', description: '사랑해서는 안 되는, 복잡하게 얽힌 운명.' },
    { id: 68, name: '폐급알바생', description: '기억하지 못하는 유년 시절의 특별한 인연.' },
    { id: 69, name: '미성년자 (학생)', description: '사회적 금기, 순수함과 위험의 경계.' },
    { id: 70, name: '소속사 대표', description: '꿈과 성공을 쥐고 흔드는, 권력의 정점.' },
    { id: 71, name: '수인', description: '헤어졌지만 끊어지지 않은, 과거의 인연.' },
    ...
    { id: 76, name: '강아지', description: '끊임없이 사건을 일으켜 주변을 곤란하게 하는 자.' },
    { id: 77, name: '집착하는 스토커', description: '일방적인 관심으로 상대를 옥죄는 위험한 존재.' },
    { id: 78, name: '기자', description: '진실 혹은 거짓을 추격하는, 날카로운 시선의 전문가.' },
    { id: 79, name: '수의사', description: '은밀하게 집으로 드나드는, 주종 관계의 전복자.' },
    { id: 80, name: '햄스터', description: '업무상 적이지만, 개인적으로 끌리는 관계.' },
];
